#!/usr/bin/env bash
# agent-error-generator — qwen2.5-coder:32b, multi-GPU (4× GH200)
#
...
#
# Submit:
#   sbatch slurm_aeg_multigpu_qwen.sh
#
# Override worker count / repeat ID:
#   sbatch --export=ALL,AEG_NUM_AGENTS=8,AEG_WORKFLOW_ID=mg_qwen_8w_4g_r1 \
#          slurm_aeg_multigpu_qwen.sh

#SBATCH --job-name=aeg-mg-qwen
...
#SBATCH --output=/work/hdd/bekn/kbateman/agent-error-generator/logs/aeg-mg-qwen-%j.out
#SBATCH --error=/work/hdd/bekn/kbateman/agent-error-generator/logs/aeg-mg-qwen-%j.err
